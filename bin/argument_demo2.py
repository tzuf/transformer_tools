...
def run_model(mode_set, user_input):
    ...
    for i,mode_id in enumerate(mode_set):
        ...
        inquire_prompt = inquire_prompt + to_key + ":"
        # inquire model
        out = model.query(inquire_prompt,prefix="gen:")[0]
        # write output
        output.append({
            'step':i,
            'mode':current_mode,
